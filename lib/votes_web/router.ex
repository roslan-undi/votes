defmodule VotesWeb.Router do
  ...
  import VotesWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {VotesWeb.LayoutView, :root}
  ...
  pipeline :api_authenticated do
    plug VotesWeb.AuthAccessPipeline
  end

  pipeline :graphql do
    plug VotesWeb.Context
  end

  scope "/api" do
    pipe_through :graphql

    forward "/", Absinthe.Plug, schema: VotesWeb.Schema
  end
  ...
  if Mix.env == :dev do
    forward "/graphiql", Absinthe.Plug.GraphiQL, schema: VotesWeb.Schema
  end
end
